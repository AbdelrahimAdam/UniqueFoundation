...
var SuperMediaMixin = (superclass, { tag, is }) => {
  var _a3, _b2, _isDefined, _define, define_fn, _isInit, _loadComplete, _hasLoaded, _isLoaded, _nativeEl, _standinEl, _init, init_fn, _upgradeProperty, upgradeProperty_fn, _initStandinEl, initStandinEl_fn, _initNativeEl, initNativeEl_fn, _loadSrc, loadSrc_fn, _forwardAttribute, forwardAttribute_fn;
  ...
  return _b2 = class extends superclass {
    constructor() {
      ...
      __privateAdd(this, _nativeEl, void 0);
    ...
    static get observedAttributes() {
      var _a4, _b3;
      __privateMethod(_a4 = _b2, _define, define_fn).call(_a4);
    ...
    attributeChangedCallback(attrName, oldValue, newValue) {
      ...
      if (attrName === "src" && this.load !== _b2.prototype.load) {
        __privateMethod(this, _loadSrc, loadSrc_fn).call(this);
      }
  ...
  }, _isInit = new WeakMap(), _loadComplete = new WeakMap(), _hasLoaded = new WeakMap(), _isLoaded = new WeakMap(), _nativeEl = new WeakMap(), _standinEl = new WeakMap(), _init = new WeakSet(), init_fn = async function() {
    var _a4, _b3;
    ...
    for (let prop of nativeElProps)
      __privateMethod(this, _upgradeProperty, upgradeProperty_fn).call(this, prop);
  ...
  }, _upgradeProperty = new WeakSet(), upgradeProperty_fn = function(prop) {
    if (Object.prototype.hasOwnProperty.call(this, prop)) {
      const value = this[prop];
      delete this[prop];
      this[prop] = value;
    }
  }, _initStandinEl = new WeakSet(), initStandinEl_fn = function() {
  ...
  }, _loadSrc = new WeakSet(), loadSrc_fn = async function() {
    var _a4;
  ...
  }, __privateAdd(_b2, _define), __publicField(_b2, "Events", Events), __publicField(_b2, "template", template), __publicField(_b2, "skipAttributes", []), __privateAdd(_b2, _isDefined, void 0), _b2;
};
...
wistia-video-element/dist/react.js:
  ...
  *)
*/
//# sourceMappingURL=react-MSW37NVJ.js.map

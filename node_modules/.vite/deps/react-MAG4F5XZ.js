...
var HlsVideoMixin = (superclass) => {
  var _a, _airplaySourceEl, _config, _destroy, destroy_fn, _toggleHlsLoad, _upgradeProperty, upgradeProperty_fn;
  return _a = class extends superclass {
    ...
    async load() {
      ...
      __privateMethod(this, _destroy, destroy_fn).call(this);
      if (!this.src) {
        return;
      }
  ...
  }, _airplaySourceEl = new WeakMap(), _config = new WeakMap(), _destroy = new WeakSet(), destroy_fn = function() {
    var _a2, _b;
  ...
  }, _toggleHlsLoad = new WeakMap(), _upgradeProperty = new WeakSet(), upgradeProperty_fn = function(prop) {
...
hls-video-element/dist/react.js:
  ...
  *)
*/
//# sourceMappingURL=react-MAG4F5XZ.js.map

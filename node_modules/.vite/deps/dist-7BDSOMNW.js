...
import {
  Hls
} from "./chunk-MNAXDFFB.js";
import {
  CustomVideoElement,
  MediaTracksMixin
} from "./chunk-KNUUFBM6.js";
import {
  require_react
} from "./chunk-QVKI3PN6.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
...
var Dr = B(function(Ns, xr) {
  ...
  K4.prototype.appendChild = at4.prototype.appendChild;
  K4.prototype.replaceChild = at4.prototype.replaceChild;
  K4.prototype.removeChild = at4.prototype.removeChild;
...
var Et = function(r12) {
  var e2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3, t3, i2, a3, n3, o4, s3 = r12 ? [console, r12] : [console], u5 = (t3 = console.trace).bind.apply(t3, W(s3)), p6 = (i2 = console.info).bind.apply(i2, W(s3)), b4 = (a3 = console.debug).bind.apply(a3, W(s3)), k3 = (n3 = console.warn).bind.apply(n3, W(s3)), y5 = (o4 = console.error).bind.apply(o4, W(s3)), c4 = e2;
...
var Ot = function(r12, e2, t3) {
  ...
  var u5 = function(m6, f6) {
    ...
    var P5 = Me(w3), R = P5.bytesLoaded, Z2 = P5.requestStart, Te3 = P5.responseStart, we3 = P5.responseEnd;
    u5("requestcompleted", fe(ue({}, Ce(S2)), { request_event_type: m6, request_bytes_loaded: R, request_start: Z2, request_response_start: Te3, request_response_end: we3, request_type: "manifest", request_hostname: F(h3), request_response_headers: Se(E4), request_rendition_lists: { media: N4, audio: M3, video: {} } }));
  };
  ...
  t3.on(a3.Events.LEVEL_SWITCHED, x7), t3._stopMuxMonitor = function() {
    t3.off(a3.Events.MANIFEST_LOADED, p6), t3.off(a3.Events.LEVEL_LOADED, b4), t3.off(a3.Events.AUDIO_TRACK_LOADED, k3), t3.off(a3.Events.FRAG_LOADED, y5), t3.off(a3.Events.FRAG_CHANGED, c4), t3.off(a3.Events.ERROR, v4), t3.off(a3.Events.FRAG_LOAD_EMERGENCY_ABORTED, T3), t3.off(a3.Events.LEVEL_SWITCHED, x7), t3.off(a3.Events.DESTROYING, t3._stopMuxMonitor), delete t3._stopMuxMonitor;
...
var It = function(r12, e2) {
  ...
  var k3 = b4 ? de(b4) : void 0;
  return { requestStart: n3, requestResponseStart: o4, requestResponseEnd: s3, requestBytesLoaded: a3, requestResponseHeaders: b4, requestMediaDuration: u5, requestHostname: t3, requestUrl: i2, requestId: k3 };
};
...
var Nt = function(r12, e2, t3) {
  ...
  var u5 = {}, p6 = function(_3) {
    ...
    M3 = M3 || [];
    var P5 = {};
    M3.forEach(function(Ee3, z3) {
      P5[z3] = {}, P5[z3].width = Ee3.width, P5[z3].height = Ee3.height, P5[z3].bitrate = Ee3.bandwidth, P5[z3].attrs = {};
    }), N4 === "video" ? u5.video = P5 : N4 === "audio" ? u5.audio = P5 : u5.media = P5;
    var R = It(w3, t3), Z2 = R.requestStart, Te3 = R.requestResponseStart, we3 = R.requestResponseEnd, G3 = R.requestResponseHeaders, oe4 = R.requestMediaDuration, Ve2 = R.requestHostname, We2 = R.requestUrl, je2 = R.requestId;
    o4("requestcompleted", { request_event_type: d4, request_start: Z2, request_response_start: Te3, request_response_end: we3, request_bytes_loaded: -1, request_type: N4 + "_init", request_response_headers: G3, request_hostname: Ve2, request_id: je2, request_url: We2, request_media_duration: oe4, request_rendition_lists: u5 });
  };
  n3 >= 4 ? t3.on("initFragmentLoaded", k3) : t3.on("initFragmentLoaded", b4);
  var y5 = function(_3) {
    var d4 = _3.type, h3 = _3.fragmentModel, w3 = _3.chunk, E4 = p6(h3);
    c4({ type: d4, request: E4, chunk: w3 });
  }, c4 = function(_3) {
    var d4 = _3.type, h3 = _3.chunk, w3 = _3.request, E4 = h3 || {}, S2 = E4.mediaInfo, N4 = E4.start, M3 = S2 || {}, P5 = M3.type, R = It(w3, t3), Z2 = R.requestStart, Te3 = R.requestResponseStart, we3 = R.requestResponseEnd, G3 = R.requestBytesLoaded, oe4 = R.requestResponseHeaders, Ve2 = R.requestMediaDuration, We2 = R.requestHostname, je2 = R.requestUrl, Ee3 = R.requestId, z3 = ua(P5, t3), Jr = z3.currentLevel, Qr2 = z3.renditionWidth, zr2 = z3.renditionHeight, Kr = z3.renditionBitrate;
    o4("requestcompleted", { request_event_type: d4, request_start: Z2, request_response_start: Te3, request_response_end: we3, request_bytes_loaded: G3, request_type: P5, request_response_headers: oe4, request_hostname: We2, request_id: Ee3, request_url: je2, request_media_start_time: N4, request_media_duration: Ve2, request_current_level: Jr, request_labeled_bitrate: Kr, request_video_width: Qr2, request_video_height: zr2 });
  };
  ...
  function e2(t3) {
    function i2(a3, n3, o4) {
      ...
      if (typeof document != "undefined") {
        ...
        a3 || (s3 = {});
        for (var p6 = document.cookie ? document.cookie.split("; ") : [], b4 = /(%[0-9A-Z]{2})+/g, k3 = 0; k3 < p6.length; k3++) {
          var y5 = p6[k3].split("="), c4 = y5.slice(1).join("=");
          c4.charAt(0) === '"' && (c4 = c4.slice(1, -1));
          try {
            var v4 = y5[0].replace(b4, decodeURIComponent);
            if (c4 = t3.read ? t3.read(c4, v4) : t3(c4, v4) || c4.replace(b4, decodeURIComponent), this.json)
              try {
                c4 = JSON.parse(c4);
              } catch (T3) {
              }
...
$.prototype._createPayload = function(r12) {
  ...
  return o4(), s3() || (q.info("Payload size is too big (" + n3 + " kb). Removing unnecessary events."), a3 = r12.filter(function(u5) {
    ...
    for (var p6 in u5) {
      var b4 = u5[p6], k3 = 50 * 1024;
      typeof b4 == "string" && b4.length > k3 && (u5[p6] = b4.substring(0, k3));
    }
  }), o4()), i2;
};
...
var Hr = function() {
  ...
  function r12(e2, t3) {
    ...
    D(this, r12);
    var a3, n3, o4, s3, u5, p6, b4, k3, y5, c4, v4, T3;
  ...
  return L(r12, [{ key: "send", value: function(t3, i2) {
    ...
    if (o4 === "-1" || t3 === "viewstart" || t3 === "viewend" || !this.previousBeaconData || this.mux.utils.now() - this.lastEventTime >= _i)
      ...
      Object.entries(i2).forEach(function(u5) {
        var p6 = H(u5, 2), b4 = p6[0], k3 = p6[1];
        a3.previousBeaconData && (k3 !== a3.previousBeaconData[b4] || ui.indexOf(b4) > -1 || a3.objectHasChanged(s3, b4, k3, a3.previousBeaconData[b4]) || a3.eventRequiresKey(t3, b4)) && (n3[b4] = k3, a3.previousBeaconData[b4] = k3);
      });
    }
    return n3;
...
var fi = function r7(e2) {
  ...
  e2.on("requestcompleted", p6), e2.on("requestfailed", b4), e2.on("requestcanceled", k3);
};
var Br = fi;
var pi = 60 * 60 * 1e3;
var vi = function r8(e2) {
  ...
  D(this, r8), l(this, "_lastEventTime", void 0), e2.on("before*", function(i2, a3) {
    ...
    if (t3._lastEventTime = o4, s3 && o4 - s3 > pi) {
      var u5 = Object.keys(e2.data).reduce(function(b4, k3) {
        return k3.indexOf("video_") === 0 ? Object.assign(b4, l({}, k3, e2.data[k3])) : b4;
      }, {});
...
function st(r12, e2, t3) {
  ...
  t3 = Object.assign(b4, t3, k3), t3.data = Object.assign({ player_software: "HTML5 Video Element", player_mux_plugin_name: "VideoElementMonitor", player_mux_plugin_version: r12.VERSION }, t3.data), a3.mux = a3.mux || {}, a3.mux.deleted = false, a3.mux.emit = function(c4, v4) {
    r12.emit(n3, c4, v4);
...
var f = L2;
var at = (e2) => e2 == null;
var O2 = (e2, t3) => at(t3) ? false : e2 in t3;
...
var Zt2 = Object.values(S);
var I = { M3U8: "application/vnd.apple.mpegurl", MP4: "video/mp4" };
var W2 = { HLS: I.M3U8 };
var er2 = Object.keys(W2);
var tr2 = [...Object.values(I), "hls", "HLS"];
var rr2 = { upTo720p: "720p", upTo1080p: "1080p", upTo1440p: "1440p", upTo2160p: "2160p" };
var nr2 = { noLessThan480p: "480p", noLessThan540p: "540p", noLessThan720p: "720p", noLessThan1080p: "1080p", noLessThan1440p: "1440p", noLessThan2160p: "2160p" };
var or2 = { DESCENDING: "desc" };
var st2 = "en";
var Y2 = { code: st2 };
...
var it = (e2) => {
  ...
  if (n3 < 0)
    return ut2(e2) ? I.M3U8 : "";
  let a3 = r12.slice(n3 + 1).toUpperCase();
  return O2(a3, I) ? I[a3] : "";
};
var ct2 = "mux.com";
var ut2 = ({ src: e2, customDomain: t3 = ct2 }) => {
  let r12;
  try {
    r12 = new URL(`${e2}`);
  } catch {
...
var ye2 = ({ exp: e2 }, t3 = Date.now()) => !e2 || e2 * 1e3 < t3;
var me = ({ sub: e2 }, t3) => e2 !== t3;
var Ee = ({ aud: e2 }, t3) => !e2;
var ge2 = ({ aud: e2 }, t3) => e2 !== t3;
var Me2 = "en";
function x(e2, t3 = true) {
  var o4, a3;
  let r12 = t3 && (a3 = (o4 = Y2) == null ? void 0 : o4[e2]) != null ? a3 : e2, n3 = t3 ? Y2.code : Me2;
  return new z(r12, n3);
}
var z = class {
  constructor(t3, r12 = ((n3) => (n3 = Y2) != null ? n3 : Me2)()) {
...
var dt2 = Object.values(K);
var xe = (e2) => typeof e2 == "boolean" || typeof e2 == "string" && dt2.includes(e2);
var Re = (e2, t3, r12) => {
  let { autoplay: n3 } = e2, o4 = false, a3 = false, i2 = xe(n3) ? n3 : !!n3, c4 = () => {
    o4 || v(t3, "playing", () => {
      o4 = true;
    }, { once: true });
  };
...
var be2 = ({ preload: e2, src: t3 }, r12, n3) => {
  let o4 = (p6) => {
...
async function ve2(e2, t3, r12, n3) {
  let o4 = w(e2, r12, n3);
...
var oe = "cuepoints";
var Pe2 = Object.freeze({ label: oe });
async function _e2(e2, t3, r12 = Pe2) {
  return ve2(e2, t3, r12.label, "metadata");
}
var $2 = (e2) => ({ time: e2.startTime, value: JSON.parse(e2.text) });
function pt2(e2, t3 = { label: oe }) {
  let r12 = w(e2, t3.label, "metadata");
  return r12 != null && r12.cues ? Array.from(r12.cues, (n3) => $2(n3)) : [];
}
function ke2(e2, t3 = { label: oe }) {
  var a3, i2;
  let r12 = w(e2, t3.label, "metadata");
...
async function he2(e2, t3 = Pe2) {
  return new Promise((r12) => {
    v(e2, "loadstart", async () => {
      let n3 = await _e2(e2, [], t3);
      v(e2, "cuechange", () => {
        let o4 = ke2(e2);
        if (o4) {
...
async function Ae2(e2, t3 = Le2) {
  return new Promise((r12) => {
    v(e2, "loadstart", async () => {
      let n3 = await Ne2(e2, [], t3);
      v(e2, "cuechange", () => {
        let o4 = Ie2(e2);
        if (o4) {
...
var H2 = (e2, t3, r12, n3, o4 = false, a3 = !((i2) => (i2 = globalThis.navigator) == null ? void 0 : i2.onLine)()) => {
  var M3, h3;
  if (a3) {
    let b4 = x("Your device appears to be offline", o4), E4 = void 0, y5 = f.MEDIA_ERR_NETWORK, k3 = new f(b4, y5, false, E4);
    return k3.errorCategory = t3, k3.muxCode = D2.NETWORK_OFFLINE, k3.data = e2, k3;
  }
  let c4 = "status" in e2 ? e2.status : e2.code, d4 = Date.now(), u5 = f.MEDIA_ERR_NETWORK;
  if (c4 === 200)
    return;
  let s3 = V2(t3), p6 = Et2(t3, r12), l4 = mt2(t3), [T3] = F2((M3 = r12.playbackId) != null ? M3 : "");
  if (!c4 || !T3)
    return;
  let m6 = ee2(p6);
  if (p6 && !m6) {
    let b4 = x("The {tokenNamePrefix}-token provided is invalid or malformed.", o4).format({ tokenNamePrefix: s3 }), E4 = x("Compact JWT string: {token}", o4).format({ token: p6 }), y5 = new f(b4, u5, true, E4);
    return y5.errorCategory = t3, y5.muxCode = D2.NETWORK_TOKEN_MALFORMED, y5.data = e2, y5;
  }
  if (c4 >= 500) {
    let b4 = new f("", u5, n3 != null ? n3 : true);
    return b4.errorCategory = t3, b4.muxCode = D2.NETWORK_UNKNOWN_ERROR, b4;
  }
  if (c4 === 403)
    if (m6) {
      if (ye2(m6, d4)) {
        let b4 = { timeStyle: "medium", dateStyle: "medium" }, E4 = x("The video’s secured {tokenNamePrefix}-token has expired.", o4).format({ tokenNamePrefix: s3 }), y5 = x("Expired at: {expiredDate}. Current time: {currentDate}.", o4).format({ expiredDate: new Intl.DateTimeFormat("en", b4).format((h3 = m6.exp) != null ? h3 : 0 * 1e3), currentDate: new Intl.DateTimeFormat("en", b4).format(d4) }), k3 = new f(E4, u5, true, y5);
        return k3.errorCategory = t3, k3.muxCode = D2.NETWORK_TOKEN_EXPIRED, k3.data = e2, k3;
      }
      if (me(m6, T3)) {
        let b4 = x("The video’s playback ID does not match the one encoded in the {tokenNamePrefix}-token.", o4).format({ tokenNamePrefix: s3 }), E4 = x("Specified playback ID: {playbackId} and the playback ID encoded in the {tokenNamePrefix}-token: {tokenPlaybackId}", o4).format({ tokenNamePrefix: s3, playbackId: T3, tokenPlaybackId: m6.sub }), y5 = new f(b4, u5, true, E4);
        return y5.errorCategory = t3, y5.muxCode = D2.NETWORK_TOKEN_SUB_MISMATCH, y5.data = e2, y5;
      }
      if (Ee(m6, l4)) {
        let b4 = x("The {tokenNamePrefix}-token is formatted with incorrect information.", o4).format({ tokenNamePrefix: s3 }), E4 = x("The {tokenNamePrefix}-token has no aud value. aud value should be {expectedAud}.", o4).format({ tokenNamePrefix: s3, expectedAud: l4 }), y5 = new f(b4, u5, true, E4);
        return y5.errorCategory = t3, y5.muxCode = D2.NETWORK_TOKEN_AUD_MISSING, y5.data = e2, y5;
      }
      if (ge2(m6, l4)) {
        let b4 = x("The {tokenNamePrefix}-token is formatted with incorrect information.", o4).format({ tokenNamePrefix: s3 }), E4 = x("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.", o4).format({ tokenNamePrefix: s3, expectedAud: l4, aud: m6.aud }), y5 = new f(b4, u5, true, E4);
        return y5.errorCategory = t3, y5.muxCode = D2.NETWORK_TOKEN_AUD_MISMATCH, y5.data = e2, y5;
      }
    } else {
      let b4 = x("Authorization error trying to access this {category} URL. If this is a signed URL, you might need to provide a {tokenNamePrefix}-token.", o4).format({ tokenNamePrefix: s3, category: t3 }), E4 = x("Specified playback ID: {playbackId}", o4).format({ playbackId: T3 }), y5 = new f(b4, u5, n3 != null ? n3 : true, E4);
      return y5.errorCategory = t3, y5.muxCode = D2.NETWORK_TOKEN_MISSING, y5.data = e2, y5;
    }
  if (c4 === 412) {
    let b4 = x("This playback-id may belong to a live stream that is not currently active or an asset that is not ready.", o4), E4 = x("Specified playback ID: {playbackId}", o4).format({ playbackId: T3 }), y5 = new f(b4, u5, n3 != null ? n3 : true, E4);
  ...
  if (c4 === 404) {
    let b4 = x("This URL or playback-id does not exist. You may have used an Asset ID or an ID from a different resource.", o4), E4 = x("Specified playback ID: {playbackId}", o4).format({ playbackId: T3 }), y5 = new f(b4, u5, n3 != null ? n3 : true, E4);
    return y5.errorCategory = t3, y5.muxCode = D2.NETWORK_NOT_FOUND, y5.data = e2, y5;
  }
  if (c4 === 400) {
    let b4 = x("The URL or playback-id was invalid. You may have used an invalid value as a playback-id."), E4 = x("Specified playback ID: {playbackId}", o4).format({ playbackId: T3 }), y5 = new f(b4, u5, n3 != null ? n3 : true, E4);
...
var Se2 = g2.DefaultConfig.capLevelController;
var j = class j2 extends Se2 {
  constructor(t3) {
    super(t3);
  }
  get levels() {
  ...
  getMaxLevel(t3) {
    ...
    return o4 >= a3 ? r12 : Se2.getMaxLevelByMediaSize(n3, a3 * (16 / 9), a3);
  }
};
...
var Ct2 = async (e2, t3) => {
  ...
  if (t3 === I.M3U8) {
    ...
    let n3 = await r12.text(), o4 = await Mt2(n3);
    return { ...xt2(n3), ...Dt2(o4) };
  }
...
var vt2 = async (e2, t3, r12 = U2({ src: e2 })) => {
  var d4, u5, s3, p6;
  let { streamType: n3, targetLiveWindow: o4, liveEdgeStartOffset: a3, sessionData: i2 } = await Ct2(e2, r12), c4 = i2 == null ? void 0 : i2["com.apple.hls.chapters"];
...
var _t2 = (e2, t3, r12) => {
  ...
  let { streamType: n3, targetLiveWindow: o4, liveEdgeStartOffset: a3, lowLatency: i2 } = Pt2(e2);
  if (n3 === _.LIVE) {
...
var He2;
var Ve;
var kt2 = (Ve = (He2 = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : He2.userAgent) != null ? Ve : "";
var Ke2;
var We;
var Ye2;
var ht2 = (Ye2 = (We = (Ke2 = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : Ke2.userAgentData) == null ? void 0 : We.platform) != null ? Ye2 : "";
var Fe2;
var $e2;
var Be;
var Lt2 = (Be = ($e2 = (Fe2 = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : Fe2.userAgentData) == null ? void 0 : $e2.brands) != null ? Be : [];
var Nt2 = kt2.toLowerCase().includes("android") || ["x11", "android"].some((e2) => ht2.toLowerCase().includes(e2));
var Oe2 = Lt2.find((e2) => e2.brand === "Google Chrome");
var It2 = (e2) => {
  var t3;
  return Oe2 && parseInt((t3 = Oe2.version) != null ? t3 : "0") >= 141 && !!e2.canPlayType("application/vnd.apple.mpegurl");
};
var P = /* @__PURE__ */ new WeakMap();
var A2 = "mux.com";
var je;
var Je2;
var Ge2 = (Je2 = (je = g2).isSupported) == null ? void 0 : Je2.call(je);
var At2 = (e2) => Nt2 || It2(e2);
var Gr2 = () => Ed.utils.now();
var St2 = Ed.utils.generateUUID;
var qr = ({ playbackId: e2, customDomain: t3 = A2, maxResolution: r12, minResolution: n3, renditionOrder: o4, programStartTime: a3, programEndTime: i2, assetStartTime: c4, assetEndTime: d4, playbackToken: u5, tokens: { playback: s3 = u5 } = {}, extraSourceParams: p6 = {} } = {}) => {
  if (!e2)
    return;
...
var wt2 = (e2) => {
  var t3, r12, n3;
  return (t3 = e2 == null ? void 0 : e2.metadata) != null && t3.video_id ? e2.metadata.video_id : tt(e2) && (n3 = (r12 = q2(e2.playbackId)) != null ? r12 : qe(e2.src)) != null ? n3 : e2.src;
};
var Ot2 = (e2) => {
  var t3;
...
var le2 = 0.034;
var Ut2 = (e2, t3, r12 = le2) => Math.abs(e2 - t3) <= r12;
var ze2 = (e2, t3, r12 = le2) => e2 > t3 || Ut2(e2, t3, r12);
var Ht2 = (e2, t3 = le2) => e2.paused && ze2(e2.currentTime, e2.duration, t3);
var Qe2 = (e2, t3) => {
  var u5, s3, p6;
...
var Vt2 = (e2, t3) => e2.ended || e2.loop ? e2.ended : t3 && Qe2(e2, t3) ? true : Ht2(e2);
var Zr2 = (e2, t3, r12) => {
  Kt2(t3, r12, e2);
  let { metadata: n3 = {} } = e2, { view_session_id: o4 = St2() } = n3, a3 = wt2(e2);
  ...
  let c4 = Wt2(e2, t3), d4 = be2(e2, t3, c4);
  e2 != null && e2.muxDataKeepSession && (t3 != null && t3.mux) && !t3.mux.deleted ? c4 && t3.mux.addHLSJS({ hlsjs: c4, Hls: c4 ? g2 : void 0 }) : Jt2(e2, t3, c4), Gt2(e2, t3, c4), he2(t3), Ae2(t3);
  let u5 = Re(e2, t3, c4);
  return { engine: c4, setAutoplay: u5, setPreload: d4 };
};
var Kt2 = (e2, t3, r12) => {
  let n3 = t3 == null ? void 0 : t3.engine;
  e2 != null && e2.mux && !e2.mux.deleted && (r12 != null && r12.muxDataKeepSession ? n3 && e2.mux.removeHLSJS() : (e2.mux.destroy(), delete e2.mux)), n3 && (n3.detachMedia(), n3.destroy()), e2 && (e2.hasAttribute("src") && (e2.removeAttribute("src"), e2.load()), e2.removeEventListener("error", nt2), e2.removeEventListener("error", ce2), e2.removeEventListener("durationchange", rt2), P.delete(e2), e2.dispatchEvent(new Event("teardown")));
};
function Ze2(e2, t3) {
  var u5;
  let r12 = U2(e2);
  if (!(r12 === I.M3U8))
    return true;
  let o4 = !r12 || ((u5 = t3.canPlayType(r12)) != null ? u5 : true), { preferPlayback: a3 } = e2, i2 = a3 === X2.MSE, c4 = a3 === X2.NATIVE, d4 = Ge2 && (i2 || At2(t3));
  return o4 && (c4 || !d4);
}
var Wt2 = (e2, t3) => {
  let { debug: r12, streamType: n3, startTime: o4 = -1, metadata: a3, preferCmcd: i2, _hlsConfig: c4 = {} } = e2, u5 = U2(e2) === I.M3U8, s3 = Ze2(e2, t3);
  if (u5 && !s3 && Ge2) {
    let p6 = { backBufferLength: 30, renderTextTracksNatively: false, liveDurationInfinity: true, capLevelToPlayerSize: true, capLevelOnFPSDrop: true }, l4 = Yt2(n3), T3 = Ft2(e2), m6 = [S.QUERY, S.HEADER].includes(i2) ? { useHeaders: i2 === S.HEADER, sessionId: a3 == null ? void 0 : a3.view_session_id, contentId: a3 == null ? void 0 : a3.video_id } : void 0, R = c4.capLevelToPlayerSize == null ? { capLevelController: we } : {}, M3 = new g2({ debug: r12, startPosition: o4, cmcd: m6, xhrSetup: (h3, b4) => {
      var k3, pe3;
      if (i2 && i2 !== S.QUERY)
        return;
      let E4 = new URL(b4);
      if (!E4.searchParams.has("CMCD"))
        return;
      let y5 = ((pe3 = (k3 = E4.searchParams.get("CMCD")) == null ? void 0 : k3.split(",")) != null ? pe3 : []).filter((fe4) => fe4.startsWith("sid") || fe4.startsWith("cid")).join(",");
      E4.searchParams.set("CMCD", y5), h3.open("GET", E4);
    }, ...R, ...p6, ...l4, ...T3, ...c4 });
    return M3.on(g2.Events.MANIFEST_PARSED, async function(h3, b4) {
      var y5, k3;
      let E4 = (y5 = b4.sessionData) == null ? void 0 : y5["com.apple.hls.chapters"];
      (E4 != null && E4.URI || E4 != null && E4.VALUE.toLocaleLowerCase().startsWith("http")) && de2((k3 = E4 == null ? void 0 : E4.URI) != null ? k3 : E4 == null ? void 0 : E4.VALUE, t3);
    }), M3;
  }
};
var Yt2 = (e2) => e2 === _.LIVE ? { backBufferLength: 8 } : {};
var Ft2 = (e2) => {
  let { tokens: { drm: t3 } = {}, playbackId: r12, drmTypeCb: n3 } = e2, o4 = q2(r12);
  return !t3 || !o4 ? {} : { emeEnabled: true, drmSystems: { "com.apple.fps": { licenseUrl: G(e2, "fairplay"), serverCertificateUrl: et(e2, "fairplay") }, "com.widevine.alpha": { licenseUrl: G(e2, "widevine") }, "com.microsoft.playready": { licenseUrl: G(e2, "playready") } }, requestMediaKeySystemAccessFunc: (a3, i2) => (a3 === "com.widevine.alpha" && (i2 = [...i2.map((c4) => {
    var u5;
  ...
  v(t3, "encrypted", async (n3) => {
    try {
      ...
      if (!t3.mediaKeys) {
        ...
        try {
          let p6 = await $t2(et(e2, "fairplay")).catch((l4) => {
      ...
      })]).then(([, u5]) => u5), d4 = await Bt2(c4, G(e2, "fairplay")).catch((u5) => {
...
var G = ({ playbackId: e2, tokens: { drm: t3 } = {}, customDomain: r12 = A2 }, n3) => {
  let o4 = q2(e2);
  return `https://license.${r12.toLocaleLowerCase().endsWith(A2) ? r12 : A2}/license/${n3}/${o4}?token=${t3}`;
};
var et = ({ playbackId: e2, tokens: { drm: t3 } = {}, customDomain: r12 = A2 }, n3) => {
  let o4 = q2(e2);
  return `https://license.${r12.toLocaleLowerCase().endsWith(A2) ? r12 : A2}/appcert/${n3}/${o4}?token=${t3}`;
};
var tt = ({ playbackId: e2, src: t3, customDomain: r12 }) => {
  if (e2)
    return true;
  if (typeof t3 != "string")
    return false;
  let n3 = window == null ? void 0 : window.location.href, o4 = new URL(t3, n3).hostname.toLocaleLowerCase();
  return o4.includes(A2) || !!r12 && o4.includes(r12.toLocaleLowerCase());
};
var Jt2 = (e2, t3, r12) => {
  var d4;
  let { envKey: n3, disableTracking: o4, muxDataSDK: a3 = Ed, muxDataSDKOptions: i2 = {} } = e2, c4 = tt(e2);
  if (!o4 && (n3 || c4)) {
...
var Gt2 = (e2, t3, r12) => {
  var s3, p6;
  let n3 = Ze2(e2, t3), { src: o4, customDomain: a3 = A2 } = e2, i2 = () => {
    t3.ended || e2.disablePseudoEnded || !Vt2(t3, r12) || (Qe2(t3, r12) ? t3.currentTime = t3.buffered.end(t3.buffered.length - 1) : t3.dispatchEvent(new Event("ended")));
  }, c4, d4, u5 = () => {
    let l4 = Xe2(t3), T3, m6;
  ...
  if (v(t3, "durationchange", u5), t3 && n3) {
    ...
    if (typeof o4 == "string") {
      if (o4.endsWith(".mp4") && o4.includes(a3)) {
        let R = qe(o4), M3 = new URL(`https://stream.${a3}/${R}/metadata.json`);
        de2(M3.toString(), t3);
      }
      let T3 = () => {
        if (Ue2(t3) !== _.LIVE || Number.isFinite(t3.duration))
          return;
      ...
      }, m6 = async () => vt2(o4, t3, l4).then(T3).catch((R) => {
      ...
      if (t3.preload === "none") {
        ...
        m6();
      (s3 = e2.tokens) != null && s3.drm ? jt2(e2, t3) : v(t3, "encrypted", () => {
        let R = x("Attempting to play DRM-protected content without providing a DRM token."), M3 = new f(R, f.MEDIA_ERR_ENCRYPTED, true);
        M3.errorCategory = C2.DRM, M3.muxCode = D2.ENCRYPTED_MISSING_TOKEN, N(t3, M3);
      }, { once: true }), t3.setAttribute("src", o4), e2.startTime && (((p6 = P.get(t3)) != null ? p6 : {}).startTime = e2.startTime, t3.addEventListener("durationchange", rt2, { once: true }));
    } else
      t3.removeAttribute("src");
    t3.addEventListener("error", nt2), t3.addEventListener("error", ce2), t3.addEventListener("emptied", () => {
      t3.querySelectorAll("track[data-removeondestroy]").forEach((m6) => {
        m6.remove();
      });
    }, { once: true }), v(t3, "pause", i2), v(t3, "seeked", i2), v(t3, "play", () => {
      t3.ended || ze2(t3.currentTime, t3.duration) && (t3.currentTime = t3.seekable.length ? t3.seekable.start(0) : 0);
    });
  } else
    r12 && o4 ? (r12.once(g2.Events.LEVEL_LOADED, (l4, T3) => {
      _t2(T3.details, t3, r12), u5(), Ue2(t3) === _.LIVE && !Number.isFinite(t3.duration) && (r12.on(g2.Events.LEVEL_UPDATED, u5), v(t3, "durationchange", () => {
      ...
      if (m6.muxCode === D2.NETWORK_NOT_READY) {
        let b4 = (R = P.get(t3)) != null ? R : {}, E4 = (M3 = b4.retryCount) != null ? M3 : 0;
        if (E4 < 6) {
          let y5 = E4 === 0 ? 5e3 : 6e4, k3 = new f(`Retrying in ${y5 / 1e3} seconds...`, m6.code, m6.fatal);
          Object.assign(k3, m6), N(t3, k3), setTimeout(() => {
            b4.retryCount = E4 + 1, T3.details === "manifestLoadError" && T3.url && r12.loadSource(T3.url);
          }, y5);
          return;
        } else {
          b4.retryCount = 0;
    ...
    }), t3.addEventListener("error", ce2), v(t3, "waiting", i2), De2(e2, r12), Ce2(t3, r12), r12.attachMedia(t3)) : console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.");
};
function rt2(e2) {
  var n3;
  let t3 = e2.target, r12 = (n3 = P.get(t3)) == null ? void 0 : n3.startTime;
  if (r12 && Te(t3.seekable, t3.duration, r12)) {
...
async function nt2(e2) {
  ...
  if (t3.src && n3 === f.MEDIA_ERR_SRC_NOT_SUPPORTED && t3.readyState === HTMLMediaElement.HAVE_NOTHING) {
    setTimeout(() => {
      var i2;
      let a3 = (i2 = Ot2(t3)) != null ? i2 : t3.error;
...
var qt2 = (e2, t3) => {
  ...
  if (i2 === f.MEDIA_ERR_NETWORK && e2.response) {
    ...
    if (e2.details === g2.ErrorDetails.KEY_SYSTEM_NO_CONFIGURED_LICENSE) {
      ...
      a3 = new f(e2.error.message, f.MEDIA_ERR_ENCRYPTED, e2.fatal), a3.errorCategory = C2.DRM, a3.muxCode = D2.ENCRYPTED_ERROR;
  else
...
var K2 = class extends CustomVideoElement {
  constructor() {
    ...
    u(this, O3);
    u(this, g3, "");
    o(this, b, Gr2()), this.nativeEl.addEventListener("muxmetadata", (t3) => {
      var d4;
      let i2 = Xr2(this.nativeEl), r12 = (d4 = this.metadata) != null ? d4 : {};
  ...
  static getLogoHTML(t3) {
    return !t3 || t3 === "false" ? "" : t3 === "default" ? D3 : `<img part="logo" src="${t3}" />`;
  }
  ...
  set preferCmcd(t3) {
    t3 !== this.preferCmcd && (t3 ? Zt2.includes(t3) ? this.setAttribute(e.PREFER_CMCD, t3) : console.warn(`Invalid value for preferCmcd. Must be one of ${Zt2.join()}`) : this.removeAttribute(e.PREFER_CMCD));
  }
  get playerInitTime() {
    return this.hasAttribute(e.PLAYER_INIT_TIME) ? +this.getAttribute(e.PLAYER_INIT_TIME) : n(this, b);
  }
  ...
  get error() {
    var t3;
    return (t3 = Ot2(this.nativeEl)) != null ? t3 : null;
  }
  get errorTranslator() {
    return n(this, O3);
  }
  ...
  get playbackId() {
    var t3;
    return this.hasAttribute(e.PLAYBACK_ID) ? this.getAttribute(e.PLAYBACK_ID) : (t3 = qe(this.src)) != null ? t3 : void 0;
  }
  set playbackId(t3) {
  ...
  get ended() {
    return Vt2(this.nativeEl, this._hls);
  }
  get envKey() {
    var t3;
  ...
  get streamType() {
    var t3;
    return (t3 = this.getAttribute(e.STREAM_TYPE)) != null ? t3 : Ue2(this.nativeEl);
  }
  set streamType(t3) {
  ...
  get seekable() {
    return Xe2(this.nativeEl);
  }
  async addCuePoints(t3) {
    return _e2(this.nativeEl, t3);
  }
  get activeCuePoint() {
    return ke2(this.nativeEl);
  }
  get cuePoints() {
    return pt2(this.nativeEl);
  }
  async addChapters(t3) {
    return Ne2(this.nativeEl, t3);
  }
  get activeChapter() {
    return Ie2(this.nativeEl);
  }
  get chapters() {
    return ft2(this.nativeEl);
  }
  getStartDate() {
    return Tt2(this.nativeEl, this._hls);
  }
  get currentPdt() {
  ...
  load() {
    o(this, l2, Zr2(this, this.nativeEl, n(this, l2)));
  }
  unload() {
    Kt2(this.nativeEl, n(this, l2), this), o(this, l2, void 0);
  }
...
l2 = /* @__PURE__ */ new WeakMap(), f2 = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakMap(), A3 = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), _2 = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), O3 = /* @__PURE__ */ new WeakMap(), g3 = /* @__PURE__ */ new WeakMap(), m = /* @__PURE__ */ new WeakSet(), y = async function() {
...
function loadCastFramework() {
  ...
  if (((_a4 = globalThis.chrome) == null ? void 0 : _a4.cast) || document.querySelector(`script[src="${sdkUrl}"]`))
    return;
...
init_fn = function() {
  ...
  __privateSet(this, _remoteListeners, {
    ...
    [cf.RemotePlayerEventType.CURRENT_TIME_CHANGED]: () => {
      var _a4;
      if (!((_a4 = __privateGet(this, _castPlayer, castPlayer_get)) == null ? void 0 : _a4.isMediaLoaded))
        return;
    ...
    [cf.RemotePlayerEventType.PLAYER_STATE_CHANGED]: () => {
      var _a4, _b;
      if (((_a4 = __privateGet(this, _castPlayer, castPlayer_get)) == null ? void 0 : _a4.playerState) === chrome.cast.media.PlayerState.PAUSED) {
        return;
      }
...
var CastableMediaMixin = (superclass) => {
  var _a4, _localState, _castOptions, _castCustomData, _remote, _castPlayer2, castPlayer_get2, _loadOnPrompt, loadOnPrompt_fn;
  return _a4 = class extends superclass {
    ...
    play() {
      ...
      if (__privateGet(this, _castPlayer2, castPlayer_get2)) {
        if (__privateGet(this, _castPlayer2, castPlayer_get2).isPaused) {
          (_a5 = __privateGet(this, _castPlayer2, castPlayer_get2).controller) == null ? void 0 : _a5.playOrPause();
        }
        return;
      }
      return super.play();
    ...
    get muted() {
      var _a5;
      if (__privateGet(this, _castPlayer2, castPlayer_get2))
        return (_a5 = __privateGet(this, _castPlayer2, castPlayer_get2)) == null ? void 0 : _a5.isMuted;
      return super.muted;
    }
    set muted(val) {
      var _a5;
      if (__privateGet(this, _castPlayer2, castPlayer_get2)) {
        if (val && !__privateGet(this, _castPlayer2, castPlayer_get2).isMuted || !val && __privateGet(this, _castPlayer2, castPlayer_get2).isMuted) {
          (_a5 = __privateGet(this, _castPlayer2, castPlayer_get2).controller) == null ? void 0 : _a5.muteOrUnmute();
        }
        return;
      }
      super.muted = val;
    ...
    get volume() {
      var _a5;
      if (__privateGet(this, _castPlayer2, castPlayer_get2))
        return ((_a5 = __privateGet(this, _castPlayer2, castPlayer_get2)) == null ? void 0 : _a5.volumeLevel) ?? 1;
      return super.volume;
    }
    set volume(val) {
      var _a5;
      if (__privateGet(this, _castPlayer2, castPlayer_get2)) {
        ...
        (_a5 = __privateGet(this, _castPlayer2, castPlayer_get2).controller) == null ? void 0 : _a5.setVolumeLevel();
        return;
      }
      super.volume = val;
    }
    get duration() {
      var _a5, _b;
      if (__privateGet(this, _castPlayer2, castPlayer_get2) && ((_a5 = __privateGet(this, _castPlayer2, castPlayer_get2)) == null ? void 0 : _a5.isMediaLoaded)) {
    ...
    set currentTime(val) {
      ...
      if (__privateGet(this, _castPlayer2, castPlayer_get2)) {
        ...
        (_a5 = __privateGet(this, _castPlayer2, castPlayer_get2).controller) == null ? void 0 : _a5.seek();
        return;
      }
...
var k = b2 ? y2.document : globalThis.document;
var r9;
  ...
  mediaIsFullscreen: {
    ...
    set(value, stateOwners, event) {
      ...
      if (!value) {
        ...
        if (isPointer)
          (_a4 = stateOwners.media) == null ? void 0 : _a4.focus();
      }
    },
...
var MediaController = class extends MediaContainer {
  ...
  get noMutedPref() {
    return getBooleanAttr(this, Attributes2.NO_MUTED_PREF);
  }
  set noMutedPref(value) {
    setBooleanAttr(this, Attributes2.NO_MUTED_PREF, value);
  }
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    var _a4, _b, _c, _d, _e4, _f, _g, _h, _i2, _j, _k;
    super.attributeChangedCallback(attrName, oldValue, newValue);
    if (attrName === Attributes2.NO_HOTKEYS) {
      ...
      (_i2 = __privateGet5(this, _mediaStore)) == null ? void 0 : _i2.dispatch({
        type: "optionschangerequest",
        detail: {
          mediaLang: newValue
        }
      });
    } else if (attrName === Attributes2.NO_VOLUME_PREF && newValue !== oldValue) {
      (_j = __privateGet5(this, _mediaStore)) == null ? void 0 : _j.dispatch({
        type: "optionschangerequest",
        detail: {
          noVolumePref: this.hasAttribute(Attributes2.NO_VOLUME_PREF)
        }
      });
    } else if (attrName === Attributes2.NO_MUTED_PREF && newValue !== oldValue) {
      (_k = __privateGet5(this, _mediaStore)) == null ? void 0 : _k.dispatch({
        type: "optionschangerequest",
        detail: {
          noMutedPref: this.hasAttribute(Attributes2.NO_MUTED_PREF)
        }
      });
    }
  }
  ...
  keyboardShortcutHandler(e2) {
    ...
    switch (e2.key) {
      ...
      case "ArrowUp": {
        const step = this.hasAttribute(Attributes2.KEYBOARD_UP_VOLUME_STEP) ? +this.getAttribute(Attributes2.KEYBOARD_UP_VOLUME_STEP) : DEFAULT_VOLUME_STEP;
        detail = Math.min(
      ...
      case "ArrowDown": {
        const step = this.hasAttribute(Attributes2.KEYBOARD_DOWN_VOLUME_STEP) ? +this.getAttribute(Attributes2.KEYBOARD_DOWN_VOLUME_STEP) : DEFAULT_VOLUME_STEP;
        detail = Math.max(
...
keyDownHandler_fn = function(e2) {
  ...
  if ([" ", "ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown"].includes(key) && !(__privateGet5(this, _hotKeys).contains(`no${key.toLowerCase()}`) || key === " " && __privateGet5(this, _hotKeys).contains("nospace")) && !isRangeInput) {
    e2.preventDefault();
  }
...
var MediaChromeDialog = class extends GlobalThis.HTMLElement {
  ...
  connectedCallback() {
    __privateMethod5(this, _init2, init_fn2).call(this);
    if (!this.role) {
      this.role = "dialog";
    }
  }
...
var MediaFullscreenButton = class extends MediaChromeButton {
  constructor() {
    super(...arguments);
    __privateAdd13(this, _lastActionEvent, null);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  handleClick(e2) {
    __privateSet13(this, _lastActionEvent, e2);
    const isPointerEvent = __privateGet13(this, _lastActionEvent) instanceof PointerEvent;
...
var MediaLoadingIndicator = class extends GlobalThis.HTMLElement {
  constructor() {
    super();
    __privateAdd14(this, _mediaController6, void 0);
    __privateAdd14(this, _delay, DEFAULT_LOADING_DELAY);
    if (!this.shadowRoot) {
      this.attachShadow(this.constructor.shadowRootOptions);
      const attrs = namedNodeMapToObject(this.attributes);
      this.shadowRoot.innerHTML = this.constructor.getTemplateHTML(attrs);
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === Attributes6.LOADING_DELAY && oldValue !== newValue) {
      ...
      if (oldValue) {
        (_b = (_a4 = __privateGet14(this, _mediaController6)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b.call(_a4, this);
        __privateSet14(this, _mediaController6, null);
      }
      if (newValue && this.isConnected) {
        __privateSet14(this, _mediaController6, (_c = this.getRootNode()) == null ? void 0 : _c.getElementById(newValue));
        (_e4 = (_d = __privateGet14(this, _mediaController6)) == null ? void 0 : _d.associateElement) == null ? void 0 : _e4.call(_d, this);
      }
    }
  }
  connectedCallback() {
    ...
    if (mediaControllerId) {
      __privateSet14(this, _mediaController6, (_a4 = this.getRootNode()) == null ? void 0 : _a4.getElementById(
        mediaControllerId
      ));
      (_c = (_b = __privateGet14(this, _mediaController6)) == null ? void 0 : _b.associateElement) == null ? void 0 : _c.call(_b, this);
    }
  }
  disconnectedCallback() {
    var _a4, _b;
   ...
   */
  get loadingDelay() {
    return __privateGet14(this, _delay);
  }
  set loadingDelay(delay2) {
    __privateSet14(this, _delay, delay2);
    const { style } = getOrInsertCSSRule(this.shadowRoot, ":host");
    style.setProperty(
...
var MediaPlaybackRateButton = class extends MediaChromeButton {
  constructor() {
    var _a4;
    super();
    __privateAdd15(this, _rates, new AttributeTokenList(this, Attributes7.RATES, {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === Attributes7.RATES) {
      __privateGet15(this, _rates).value = newValue;
    }
   ...
   */
  get rates() {
    return __privateGet15(this, _rates);
  }
  /**
  ...
  set rates(value) {
    if (!value) {
      __privateGet15(this, _rates).value = "";
    } else if (Array.isArray(value)) {
      __privateGet15(this, _rates).value = value.join(" ");
    } else if (typeof value === "string") {
      __privateGet15(this, _rates).value = value;
    }
  }
  /**
  ...
  handleClick() {
    var _a4, _b;
    const availableRates = Array.from(__privateGet15(this, _rates).values(), (str) => +str).sort(
      (a3, b4) => a3 - b4
    );
...
var MediaPreviewChapterDisplay = class extends MediaTextDisplay {
  constructor() {
    super();
    __privateAdd16(this, _slot2, void 0);
    __privateSet15(this, _slot2, this.shadowRoot.querySelector("slot"));
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_PREVIEW_CHAPTER || attrName === MediaUIAttributes.MEDIA_LANG) {
      if (newValue !== oldValue && newValue != null) {
        __privateGet16(this, _slot2).textContent = newValue;
        if (newValue !== "") {
...
var MediaPreviewThumbnail = class extends GlobalThis.HTMLElement {
  constructor() {
    super();
    __privateAdd17(this, _mediaController7, void 0);
    if (!this.shadowRoot) {
      this.attachShadow(this.constructor.shadowRootOptions);
      const attrs = namedNodeMapToObject(this.attributes);
      this.shadowRoot.innerHTML = this.constructor.getTemplateHTML(attrs);
  ...
  connectedCallback() {
    ...
    if (mediaControllerId) {
      ...
      (_c = (_b = __privateGet17(this, _mediaController7)) == null ? void 0 : _b.associateElement) == null ? void 0 : _c.call(_b, this);
    }
  }
  disconnectedCallback() {
    var _a4, _b;
    (_b = (_a4 = __privateGet17(this, _mediaController7)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b.call(_a4, this);
    __privateSet16(this, _mediaController7, null);
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
    var _a4, _b, _c, _d, _e4;
    if ([
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      ...
      if (newValue && this.isConnected) {
        __privateSet16(this, _mediaController7, (_c = this.getRootNode()) == null ? void 0 : _c.getElementById(newValue));
        (_e4 = (_d = __privateGet17(this, _mediaController7)) == null ? void 0 : _d.associateElement) == null ? void 0 : _e4.call(_d, this);
      }
    }
  }
  /**
...
var MediaPreviewTimeDisplay = class extends MediaTextDisplay {
  constructor() {
    super();
    __privateAdd18(this, _slot3, void 0);
    __privateSet17(this, _slot3, this.shadowRoot.querySelector("slot"));
    __privateGet18(this, _slot3).textContent = formatTime(0);
  }
  static get observedAttributes() {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_PREVIEW_TIME && newValue != null) {
      __privateGet18(this, _slot3).textContent = formatTime(parseFloat(newValue));
    }
  }
  /**
...
var MediaTimeDisplay = class extends MediaTextDisplay {
  constructor() {
    ...
    __privateSet18(this, _slot4, this.shadowRoot.querySelector("slot"));
...
var __privateWrapper = (obj, member, setter, getter) => ({
  set _(value) {
    __privateSet19(obj, member, value, setter);
  },
  get _() {
    return __privateGet20(obj, member, getter);
  }
});
var _range;
var _startTime;
...
var RangeAnimation = class {
  constructor(range, callback, fps) {
    __privateAdd20(this, _range, void 0);
    __privateAdd20(this, _startTime, void 0);
    __privateAdd20(this, _previousTime, void 0);
    __privateAdd20(this, _deltaTime, void 0);
    __privateAdd20(this, _frameCount, void 0);
    __privateAdd20(this, _updateTimestamp, void 0);
    __privateAdd20(this, _updateStartValue, void 0);
    __privateAdd20(this, _lastRangeIncrease, void 0);
    __privateAdd20(this, _id, 0);
    __privateAdd20(this, _animate, (now = performance.now()) => {
      __privateSet19(this, _id, requestAnimationFrame(__privateGet20(this, _animate)));
      __privateSet19(this, _deltaTime, performance.now() - __privateGet20(this, _previousTime));
      const fpsInterval = 1e3 / this.fps;
      if (__privateGet20(this, _deltaTime) > fpsInterval) {
        __privateSet19(this, _previousTime, now - __privateGet20(this, _deltaTime) % fpsInterval);
        const fps2 = 1e3 / ((now - __privateGet20(this, _startTime)) / ++__privateWrapper(this, _frameCount)._);
        const delta = (now - __privateGet20(this, _updateTimestamp)) / 1e3 / this.duration;
        let value = __privateGet20(this, _updateStartValue) + delta * this.playbackRate;
        const increase = value - __privateGet20(this, _range).valueAsNumber;
        if (increase > 0) {
          __privateSet19(this, _lastRangeIncrease, this.playbackRate / this.duration / fps2);
        } else {
          __privateSet19(this, _lastRangeIncrease, 0.995 * __privateGet20(this, _lastRangeIncrease));
          value = __privateGet20(this, _range).valueAsNumber + __privateGet20(this, _lastRangeIncrease);
        }
        this.callback(value);
      }
    });
    __privateSet19(this, _range, range);
    this.callback = callback;
    this.fps = fps;
  }
  start() {
    if (__privateGet20(this, _id) !== 0)
      return;
    __privateSet19(this, _previousTime, performance.now());
    __privateSet19(this, _startTime, __privateGet20(this, _previousTime));
    __privateSet19(this, _frameCount, 0);
    __privateGet20(this, _animate).call(this);
  }
  stop() {
    if (__privateGet20(this, _id) === 0)
      return;
    cancelAnimationFrame(__privateGet20(this, _id));
    __privateSet19(this, _id, 0);
  }
  update({ start, duration, playbackRate }) {
    const increase = start - __privateGet20(this, _range).valueAsNumber;
    const durationDelta = Math.abs(duration - this.duration);
    if (increase > 0 || increase < -0.03 || durationDelta >= 0.5) {
      this.callback(start);
    }
    __privateSet19(this, _updateStartValue, start);
    __privateSet19(this, _updateTimestamp, performance.now());
...
var MediaTimeRange = class extends MediaChromeRange {
  constructor() {
    ...
    __privateSet20(this, _boxes, this.shadowRoot.querySelectorAll('[part~="box"]'));
    __privateSet20(this, _previewBox, this.shadowRoot.querySelector('[part~="preview-box"]'));
    __privateSet20(this, _currentBox, this.shadowRoot.querySelector('[part~="current-box"]'));
    const computedStyle = getComputedStyle(this);
    __privateSet20(this, _boxPaddingLeft, parseInt(
      computedStyle.getPropertyValue("--media-box-padding-left")
    ));
    __privateSet20(this, _boxPaddingRight, parseInt(
      computedStyle.getPropertyValue("--media-box-padding-right")
    ));
    __privateSet20(this, _animation, new RangeAnimation(this.range, __privateGet21(this, _updateRange), 60));
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  connectedCallback() {
    ...
    __privateSet20(this, _rootNode, this.getRootNode());
    (_a4 = __privateGet21(this, _rootNode)) == null ? void 0 : _a4.addEventListener("transitionstart", this);
  }
  disconnectedCallback() {
    var _a4;
    super.disconnectedCallback();
    __privateMethod7(this, _toggleRangeAnimation, toggleRangeAnimation_fn).call(this);
    (_a4 = __privateGet21(this, _rootNode)) == null ? void 0 : _a4.removeEventListener("transitionstart", this);
    __privateSet20(this, _rootNode, null);
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
    super.attributeChangedCallback(attrName, oldValue, newValue);
    ...
    if (attrName === MediaUIAttributes.MEDIA_CURRENT_TIME || attrName === MediaUIAttributes.MEDIA_PAUSED || attrName === MediaUIAttributes.MEDIA_ENDED || attrName === MediaUIAttributes.MEDIA_LOADING || attrName === MediaUIAttributes.MEDIA_DURATION || attrName === MediaUIAttributes.MEDIA_SEEKABLE) {
      __privateGet21(this, _animation).update({
    ...
    if (attrName === MediaUIAttributes.MEDIA_DURATION || attrName === MediaUIAttributes.MEDIA_SEEKABLE) {
      this.mediaChaptersCues = __privateGet21(this, _mediaChaptersCues);
      this.updateBar();
    }
  }
  get mediaChaptersCues() {
    return __privateGet21(this, _mediaChaptersCues);
  }
  set mediaChaptersCues(value) {
    var _a4;
    __privateSet20(this, _mediaChaptersCues, value);
    this.updateSegments(
      (_a4 = __privateGet21(this, _mediaChaptersCues)) == null ? void 0 : _a4.map((c4) => ({
  ...
  handleEvent(evt) {
    ...
    switch (evt.type) {
      ...
      case "pointerup":
        if (__privateGet21(this, _isPointerDown))
          __privateSet20(this, _isPointerDown, false);
        break;
      case "pointerdown":
        __privateSet20(this, _isPointerDown, true);
        break;
      case "pointerleave":
...
getBoxShiftPosition_fn = function(rects, ratio) {
  ...
  if (pointerX < min + __privateGet21(this, _boxPaddingLeft)) {
    const offset = rects.range.left - rects.bounds.left - __privateGet21(this, _boxPaddingLeft);
    return `${pointerX - width / 2 + offset}px`;
  }
  if (pointerX > max - __privateGet21(this, _boxPaddingRight)) {
    const offset = rects.bounds.right - rects.range.right - __privateGet21(this, _boxPaddingRight);
...
handlePointerMove_fn3 = function(evt) {
  const isOverBoxes = [...__privateGet21(this, _boxes)].some(
  ...
  const diff = Math.round(__privateGet21(this, _previewTime)) - Math.round(pointerRatio * duration);
  if (Math.abs(diff) < 1 && pointerRatio > 0.01 && pointerRatio < 0.99)
    return;
  __privateSet20(this, _previewTime, pointerRatio * duration);
...
var TemplateInstance = class extends GlobalThis.DocumentFragment {
  constructor(template, state, processor2 = defaultProcessor) {
    var _a4;
    super();
    __privateAdd22(this, _parts, void 0);
    __privateAdd22(this, _processor, void 0);
    this.append(template.content.cloneNode(true));
    __privateSet21(this, _parts, parse(this));
    __privateSet21(this, _processor, processor2);
    (_a4 = processor2.createCallback) == null ? void 0 : _a4.call(processor2, this, __privateGet22(this, _parts), state);
    processor2.processCallback(this, __privateGet22(this, _parts), state);
  }
  update(state) {
    __privateGet22(this, _processor).processCallback(this, __privateGet22(this, _parts), state);
  }
};
...
var AttrPartList = class {
  constructor() {
    __privateAdd22(this, _items, []);
  }
  [Symbol.iterator]() {
    return __privateGet22(this, _items).values();
  }
  get length() {
    return __privateGet22(this, _items).length;
  }
  item(index) {
    return __privateGet22(this, _items)[index];
  }
  append(...items) {
    for (const item of items) {
      ...
      __privateGet22(this, _items).push(item);
    }
  }
  toString() {
    return __privateGet22(this, _items).join("");
  }
};
...
var AttrPart = class extends Part {
  constructor(element, attributeName, namespaceURI) {
    super();
    __privateAdd22(this, _list);
    __privateAdd22(this, _value, "");
    __privateAdd22(this, _element, void 0);
    __privateAdd22(this, _attributeName, void 0);
    __privateAdd22(this, _namespaceURI, void 0);
    __privateSet21(this, _element, element);
    __privateSet21(this, _attributeName, attributeName);
    __privateSet21(this, _namespaceURI, namespaceURI);
  }
  get attributeName() {
    return __privateGet22(this, _attributeName);
  }
  get attributeNamespace() {
    return __privateGet22(this, _namespaceURI);
  }
  get element() {
    return __privateGet22(this, _element);
  }
  get value() {
    return __privateGet22(this, _value);
  }
  set value(newValue) {
    if (__privateGet22(this, _value) === newValue)
      return;
    __privateSet21(this, _value, newValue);
    if (!__privateGet22(this, _list, list_get) || __privateGet22(this, _list, list_get).length === 1) {
      if (newValue == null) {
        __privateGet22(this, _element).removeAttributeNS(
          __privateGet22(this, _namespaceURI),
          __privateGet22(this, _attributeName)
        );
      } else {
        __privateGet22(this, _element).setAttributeNS(
          __privateGet22(this, _namespaceURI),
          __privateGet22(this, _attributeName),
          newValue
        );
      ...
      __privateGet22(this, _element).setAttributeNS(
        __privateGet22(this, _namespaceURI),
        __privateGet22(this, _attributeName),
        __privateGet22(this, _list, list_get).toString()
      );
    }
  }
  get booleanValue() {
    return __privateGet22(this, _element).hasAttributeNS(
      __privateGet22(this, _namespaceURI),
      __privateGet22(this, _attributeName)
    );
  }
...
var ChildNodePart = class extends Part {
  constructor(parentNode, nodes) {
    super();
    __privateAdd22(this, _parentNode, void 0);
    __privateAdd22(this, _nodes, void 0);
    __privateSet21(this, _parentNode, parentNode);
    __privateSet21(this, _nodes, nodes ? [...nodes] : [new Text()]);
  }
  get replacementNodes() {
    return __privateGet22(this, _nodes);
  }
  get parentNode() {
    return __privateGet22(this, _parentNode);
  }
  get nextSibling() {
    return __privateGet22(this, _nodes)[__privateGet22(this, _nodes).length - 1].nextSibling;
  }
  get previousSibling() {
    return __privateGet22(this, _nodes)[0].previousSibling;
  }
  // FIXME: not sure why do we need string serialization here? Just because parent class has type DOMString?
  get value() {
    return __privateGet22(this, _nodes).map((node) => node.textContent).join("");
  }
  set value(newValue) {
  ...
  replace(...nodes) {
    ...
    __privateSet21(this, _nodes, swapdom(
      __privateGet22(this, _nodes)[0].parentNode,
      __privateGet22(this, _nodes),
      normalisedNodes,
      this.nextSibling
    ));
  }
...
var MediaThemeElement = class extends GlobalThis.HTMLElement {
  constructor() {
    super();
    __privateAdd23(this, _upgradeProperty);
    __privateAdd23(this, _updateTemplate);
    __privateAdd23(this, _template, void 0);
    __privateAdd23(this, _prevTemplate, void 0);
    __privateAdd23(this, _prevTemplateId, void 0);
    if (this.shadowRoot) {
  ...
  get template() {
    var _a4;
    return (_a4 = __privateGet23(this, _template)) != null ? _a4 : this.constructor.template;
  }
  set template(value) {
    if (value === null) {
    ...
    if (typeof value === "string") {
      ...
      __privateSet22(this, _template, value);
      __privateSet22(this, _prevTemplateId, null);
      this.createRenderer();
    }
  }
  get props() {
  ...
  createRenderer() {
    if (this.template instanceof HTMLTemplateElement && this.template !== __privateGet23(this, _prevTemplate)) {
      __privateSet22(this, _prevTemplate, this.template);
...
updateTemplate_fn = function() {
  ...
  if (!templateId || templateId === __privateGet23(this, _prevTemplateId))
    return;
  ...
  if (template) {
    __privateSet22(this, _prevTemplateId, templateId);
    __privateSet22(this, _template, template);
    this.createRenderer();
    return;
  }
  if (isValidUrl(templateId)) {
    ...
    request(templateId).then((data) => {
      ...
      __privateSet22(this, _template, template2);
      this.createRenderer();
    }).catch(console.error);
  }
};
...
var MediaChromeMenu = class extends GlobalThis.HTMLElement {
  constructor() {
    super();
    __privateAdd24(this, _handleSlotChange);
    __privateAdd24(this, _toggleHeader);
    __privateAdd24(this, _updateLayoutStyle);
    __privateAdd24(this, _handleInvoke2);
    __privateAdd24(this, _handleOpen2);
    __privateAdd24(this, _handleClosed2);
    __privateAdd24(this, _positionMenu);
    __privateAdd24(this, _resizeMenu);
    __privateAdd24(this, _handleClick);
    __privateAdd24(this, _backButtonElement);
    __privateAdd24(this, _handleToggle);
    __privateAdd24(this, _checkSubmenuHasExpanded);
    __privateAdd24(this, _handleFocusOut2);
    __privateAdd24(this, _handleKeyDown2);
    __privateAdd24(this, _getItem);
    __privateAdd24(this, _getTabItem);
    __privateAdd24(this, _setTabItem);
    __privateAdd24(this, _selectItem);
    __privateAdd24(this, _mediaController8, null);
    __privateAdd24(this, _previouslyFocused2, null);
    __privateAdd24(this, _invokerElement2, null);
    __privateAdd24(this, _previousItems, /* @__PURE__ */ new Set());
    __privateAdd24(this, _mutationObserver2, void 0);
    __privateAdd24(this, _isPopover, false);
    __privateAdd24(this, _cssRule, null);
    __privateAdd24(this, _handleMenuItems, () => {
      const previousItems = __privateGet24(this, _previousItems);
      ...
      __privateSet23(this, _previousItems, currentItems);
    });
    __privateAdd24(this, _handleBoundsResize, () => {
    ...
    __privateAdd24(this, _handleMenuResize, () => {
      __privateMethod9(this, _positionMenu, positionMenu_fn).call(this);
    });
    if (!this.shadowRoot) {
      this.attachShadow(this.constructor.shadowRootOptions);
    ...
    __privateSet23(this, _mutationObserver2, new MutationObserver(__privateGet24(this, _handleMenuItems)));
  ...
  connectedCallback() {
    var _a4, _b;
    __privateSet23(this, _cssRule, insertCSSRule(this.shadowRoot, ":host"));
    ...
    __privateSet23(this, _mediaController8, getAttributeMediaController(this));
    (_b = (_a4 = __privateGet24(this, _mediaController8)) == null ? void 0 : _a4.associateElement) == null ? void 0 : _b.call(_a4, this);
    if (!this.hidden) {
      observeResize(getBoundsElement(this), __privateGet24(this, _handleBoundsResize));
      observeResize(this, __privateGet24(this, _handleMenuResize));
    }
    __privateMethod9(this, _toggleHeader, toggleHeader_fn).call(this);
  }
  disconnectedCallback() {
    var _a4, _b;
    unobserveResize(getBoundsElement(this), __privateGet24(this, _handleBoundsResize));
    unobserveResize(this, __privateGet24(this, _handleMenuResize));
    this.disable();
    (_b = (_a4 = __privateGet24(this, _mediaController8)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b.call(_a4, this);
    __privateSet23(this, _mediaController8, null);
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
    var _a4, _b, _c, _d;
    if (attrName === Attributes12.HIDDEN && newValue !== oldValue) {
      if (!__privateGet24(this, _isPopover))
        __privateSet23(this, _isPopover, true);
      if (this.hidden) {
      ...
      if (newValue && this.isConnected) {
        __privateSet23(this, _mediaController8, getAttributeMediaController(this));
        (_d = (_c = __privateGet24(this, _mediaController8)) == null ? void 0 : _c.associateElement) == null ? void 0 : _d.call(_c, this);
      }
  ...
  focus() {
    __privateSet23(this, _previouslyFocused2, getActiveElement());
  ...
  handleSelect(event) {
    ...
    if (__privateGet24(this, _invokerElement2) && !this.hidden) {
      (_a4 = __privateGet24(this, _previouslyFocused2)) == null ? void 0 : _a4.focus();
      this.hidden = true;
    }
  }
  get keysUsed() {
...
handleSlotChange_fn = function(event) {
  ...
  if (!slot.name) {
    __privateGet24(this, _handleMenuItems).call(this);
  }
};
...
handleInvoke_fn2 = function(event) {
  __privateSet23(this, _invokerElement2, event.relatedTarget);
  if (!containsComposedNode(this, event.relatedTarget)) {
...
handleOpen_fn2 = function() {
  var _a4;
  (_a4 = __privateGet24(this, _invokerElement2)) == null ? void 0 : _a4.setAttribute("aria-expanded", "true");
  this.addEventListener("transitionend", () => this.focus(), { once: true });
  observeResize(getBoundsElement(this), __privateGet24(this, _handleBoundsResize));
  observeResize(this, __privateGet24(this, _handleMenuResize));
};
...
handleClosed_fn2 = function() {
  var _a4;
  (_a4 = __privateGet24(this, _invokerElement2)) == null ? void 0 : _a4.setAttribute("aria-expanded", "false");
  unobserveResize(getBoundsElement(this), __privateGet24(this, _handleBoundsResize));
  unobserveResize(this, __privateGet24(this, _handleMenuResize));
};
...
positionMenu_fn = function(menuWidth) {
  ...
  const { style } = __privateGet24(this, _cssRule);
...
handleClick_fn = function(event) {
  var _a4;
  event.stopPropagation();
  if (event.composedPath().includes(__privateGet24(this, _backButtonElement, backButtonElement_get))) {
    (_a4 = __privateGet24(this, _previouslyFocused2)) == null ? void 0 : _a4.focus();
    this.hidden = true;
    return;
  }
...
handleFocusOut_fn2 = function(event) {
  ...
  if (!containsComposedNode(this, event.relatedTarget)) {
    ...
    if (__privateGet24(this, _invokerElement2) && __privateGet24(this, _invokerElement2) !== event.relatedTarget && !this.hidden) {
      this.hidden = true;
    }
  }
};
...
handleKeyDown_fn2 = function(event) {
  ...
  if (key === "Tab") {
    ...
    (_e4 = __privateGet24(this, _previouslyFocused2)) == null ? void 0 : _e4.focus();
    if (__privateGet24(this, _isPopover)) {
      this.hidden = true;
    }
...
var MediaChromeMenuItem = class extends GlobalThis.HTMLElement {
  constructor() {
    ...
    __privateAdd25(this, _submenuConnected);
    __privateAdd25(this, _submenuDisconnected);
    __privateAdd25(this, _handleKeyUp);
    __privateAdd25(this, _handleKeyDown3);
    __privateAdd25(this, _reset);
    __privateAdd25(this, _dirty, false);
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    if (attrName === Attributes13.CHECKED && isCheckable(this) && !__privateGet25(this, _dirty)) {
  ...
  connectedCallback() {
    ...
    __privateSet24(this, _ownerElement, closestMenuItemsContainer(this, this.parentNode));
  ...
  disconnectedCallback() {
    this.disable();
    __privateMethod10(this, _reset, reset_fn).call(this);
    __privateSet24(this, _ownerElement, null);
  }
  get invokeTarget() {
  ...
  set checked(value) {
    if (!isCheckable(this))
      return;
    __privateSet24(this, _dirty, true);
...
submenuConnected_fn = async function() {
  ...
  this.submenuElement.addEventListener("change", __privateGet25(this, _handleMenuItem));
  this.submenuElement.addEventListener("addmenuitem", __privateGet25(this, _handleMenuItem));
  this.submenuElement.addEventListener(
    "removemenuitem",
    __privateGet25(this, _handleMenuItem)
  );
  __privateGet25(this, _handleMenuItem).call(this);
};
_submenuDisconnected = /* @__PURE__ */ new WeakSet();
submenuDisconnected_fn = function() {
  this.removeAttribute("aria-haspopup");
  this.removeAttribute("aria-expanded");
  this.submenuElement.removeEventListener("change", __privateGet25(this, _handleMenuItem));
...
reset_fn = function() {
  var _a4;
  const items = (_a4 = __privateGet25(this, _ownerElement)) == null ? void 0 : _a4.radioGroupItems;
  if (!items)
    return;
...
var MediaAudioTrackMenu = class extends MediaChromeMenu {
  constructor() {
    super(...arguments);
    __privateAdd26(this, _render);
    __privateAdd26(this, _onChange);
    __privateAdd26(this, _audioTrackList, []);
    __privateAdd26(this, _prevState, void 0);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_AUDIO_TRACK_ENABLED && oldValue !== newValue) {
      ...
      __privateSet25(this, _audioTrackList, parseAudioTrackList(newValue != null ? newValue : ""));
  ...
  get mediaAudioTrackList() {
    return __privateGet26(this, _audioTrackList);
  }
  set mediaAudioTrackList(list) {
    __privateSet25(this, _audioTrackList, list);
    __privateMethod11(this, _render, render_fn).call(this);
  }
  /**
...
render_fn = function() {
  if (__privateGet26(this, _prevState) === JSON.stringify(this.mediaAudioTrackList))
    return;
  __privateSet25(this, _prevState, JSON.stringify(this.mediaAudioTrackList));
  const audioTrackList = this.mediaAudioTrackList;
  this.defaultSlot.textContent = "";
  audioTrackList.sort((a3, b4) => a3.id.localeCompare(b4.id, void 0, { numeric: true }));
...
var MediaCaptionsMenu = class extends MediaChromeMenu {
  constructor() {
    super(...arguments);
    __privateAdd27(this, _render2);
    __privateAdd27(this, _onChange2);
    __privateAdd27(this, _prevState2, void 0);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
...
render_fn2 = function() {
  var _a4;
  if (__privateGet27(this, _prevState2) === JSON.stringify(this.mediaSubtitlesList))
    return;
  __privateSet26(this, _prevState2, JSON.stringify(this.mediaSubtitlesList));
  this.defaultSlot.textContent = "";
...
var MediaPlaybackRateMenu = class extends MediaChromeMenu {
  constructor() {
    ...
    __privateAdd28(this, _rates2, new AttributeTokenList(this, Attributes14.RATES, {
      defaultValue: DEFAULT_RATES
    }));
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_PLAYBACK_RATE && oldValue != newValue) {
      ...
      __privateGet28(this, _rates2).value = newValue;
      __privateMethod13(this, _render3, render_fn3).call(this);
    }
  }
  connectedCallback() {
   ...
   */
  get rates() {
    return __privateGet28(this, _rates2);
  }
  /**
   * Set the playback rates for the button.
   * For React 19+ compatibility, accept a string of space-separated rates.
  ...
  set rates(value) {
    if (!value) {
      __privateGet28(this, _rates2).value = "";
    } else if (Array.isArray(value)) {
      __privateGet28(this, _rates2).value = value.join(" ");
    } else if (typeof value === "string") {
      __privateGet28(this, _rates2).value = value;
    }
    __privateMethod13(this, _render3, render_fn3).call(this);
  }
  /**
...
render_fn3 = function() {
  this.defaultSlot.textContent = "";
  for (const rate of __privateGet28(this, _rates2)) {
    const item = createMenuItem({
      type: "radio",
...
var MediaRenditionMenu = class extends MediaChromeMenu {
  ...
  static compareRendition(a3, b4) {
    var _a4, _b;
    return b4.height === a3.height ? ((_a4 = b4.bitrate) != null ? _a4 : 0) - ((_b = a3.bitrate) != null ? _b : 0) : b4.height - a3.height;
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
    super.attributeChangedCallback(attrName, oldValue, newValue);
  ...
  compareRendition(a3, b4) {
    const ctor = this.constructor;
    return ctor.compareRendition(a3, b4);
  }
  ...
  showRenditionBitrate(rendition) {
    return this.mediaRenditionList.some(
      (r12) => r12 !== rendition && r12.height === rendition.height && r12.bitrate !== rendition.bitrate
    );
  }
};
...
render_fn4 = function() {
  if (__privateGet29(this, _prevState3).mediaRenditionList === JSON.stringify(this.mediaRenditionList) && __privateGet29(this, _prevState3).mediaHeight === this.mediaHeight)
    return;
  __privateGet29(this, _prevState3).mediaRenditionList = JSON.stringify(
...
var _closeContextMenu;
var closeContextMenu_fn;
var _closeOtherContextMenus;
var closeOtherContextMenus_fn;
var _isVideoContainer;
var isVideoContainer_fn;
var _onControllerContextMenu;
var _onContextMenu;
var onContextMenu_fn;
...
var MediaContextMenu = class extends MediaChromeMenu {
  constructor() {
    super();
    __privateAdd30(this, _updateVisibility);
    __privateAdd30(this, _closeContextMenu);
    __privateAdd30(this, _closeOtherContextMenus);
    __privateAdd30(this, _isVideoContainer);
    __privateAdd30(this, _onContextMenu);
    __privateAdd30(this, _isContextMenuOpen, false);
    __privateAdd30(this, _onControllerContextMenu, (event) => {
      ...
      if (isVideoElement || isVideoContainer) {
        if (!__privateGet30(this, _isContextMenuOpen)) {
    ...
    __privateAdd30(this, _onDocumentClick, (event) => {
      const target = event.target;
    ...
    __privateAdd30(this, _onKeyDown, (event) => {
      if (event.key === "Escape") {
        __privateMethod15(this, _closeContextMenu, closeContextMenu_fn).call(this);
      }
    });
    __privateAdd30(this, _onMenuClick, (event) => {
      var _a4, _b;
      const target = event.target;
      if ((_a4 = target.matches) == null ? void 0 : _a4.call(target, 'button[invoke="copy"]')) {
  ...
  connectedCallback() {
    ...
    getMediaController(this).addEventListener(
      "contextmenu",
      __privateGet30(this, _onControllerContextMenu)
    );
    this.addEventListener("click", __privateGet30(this, _onMenuClick));
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    ...
    this.removeEventListener("click", __privateGet30(this, _onMenuClick));
    document.removeEventListener("mousedown", __privateGet30(this, _onDocumentClick));
    document.removeEventListener("keydown", __privateGet30(this, _onKeyDown));
  }
};
_isContextMenuOpen = /* @__PURE__ */ new WeakMap();
_updateVisibility = /* @__PURE__ */ new WeakSet();
updateVisibility_fn = function() {
  this.hidden = !__privateGet30(this, _isContextMenuOpen);
};
_closeContextMenu = /* @__PURE__ */ new WeakSet();
closeContextMenu_fn = function() {
  __privateSet28(this, _isContextMenuOpen, false);
  __privateMethod15(this, _updateVisibility, updateVisibility_fn).call(this);
};
...
closeOtherContextMenus_fn = function() {
  ...
  allContextMenus.forEach((menu) => {
    var _a4;
    if (menu !== this) {
      __privateMethod15(_a4 = menu, _closeContextMenu, closeContextMenu_fn).call(_a4);
    }
  });
};
...
onContextMenu_fn = function(event) {
  ...
  __privateSet28(this, _isContextMenuOpen, true);
  this.style.position = "fixed";
  this.style.left = `${event.clientX}px`;
  this.style.top = `${event.clientY}px`;
  __privateMethod15(this, _updateVisibility, updateVisibility_fn).call(this);
  document.addEventListener("mousedown", __privateGet30(this, _onDocumentClick), {
    once: true
  });
  document.addEventListener("keydown", __privateGet30(this, _onKeyDown), { once: true });
};
_onDocumentClick = /* @__PURE__ */ new WeakMap();
_onKeyDown = /* @__PURE__ */ new WeakMap();
_onMenuClick = /* @__PURE__ */ new WeakMap();
MediaContextMenu.getTemplateHTML = getTemplateHTML18;
...
function getTemplateHTML19(_attrs) {
  return (
    /*html*/
    `
    ${MediaChromeMenuItem.getTemplateHTML.call(this, _attrs)}
...
MediaContextMenuItem.getTemplateHTML = getTemplateHTML19;
...
var E = (t3, a3, e2) => a3.has(t3) ? Je3("Cannot add the same private member more than once") : a3 instanceof WeakSet ? a3.add(t3) : a3.set(t3, e2);
...
var G2 = class extends F3 {
};
var ge3 = class extends F3 {
};
var Ut3 = { get(t3) {
}, define(t3, a3, e2) {
}, getName(t3) {
...
var et2 = { document: { createElement: Vt3 }, DocumentFragment, customElements: Ut3, CustomEvent: fe2, EventTarget: F3, HTMLElement: G2, HTMLVideoElement: ge3 };
var tt2 = typeof window == "undefined" || typeof globalThis.customElements == "undefined";
var k2 = tt2 ? et2 : globalThis;
var P3 = tt2 ? et2.document : globalThis.document;
function at3(t3) {
  let a3 = "";
...
var Kt3 = Ht3();
var se3 = () => Kt3;
var ot2 = (t3, { token: a3, customDomain: e2 = rt3, thumbnailTime: i2, programTime: r12 } = {}) => {
  var l4;
...
var $t3 = { crossorigin: "crossOrigin", playsinline: "playsInline" };
function st3(t3) {
  var a3;
  return (a3 = $t3[t3]) != null ? a3 : oe2(t3);
}
var D4;
var U3;
var v3;
var ne3 = class {
  ...
  add(...a3) {
    ...
    }), !(this.value === "" && !((e2 = u3(this, D4)) != null && e2.hasAttribute(`${u3(this, U3)}`))) && ((i2 = u3(this, D4)) == null || i2.setAttribute(`${u3(this, U3)}`, `${this.value}`));
  }
  remove(...a3) {
    var e2;
    a3.forEach((i2) => {
      u3(this, v3).splice(u3(this, v3).indexOf(i2), 1);
    }), (e2 = u3(this, D4)) == null || e2.setAttribute(`${u3(this, U3)}`, `${this.value}`);
  }
  contains(a3) {
...
D4 = /* @__PURE__ */ new WeakMap(), U3 = /* @__PURE__ */ new WeakMap(), v3 = /* @__PURE__ */ new WeakMap();
...
var Yt3 = Object.values(g5).filter((t3) => g5.PLAYSINLINE !== t3);
...
var Ae3 = class extends k2.HTMLElement {
  ...
  set playsInline(a3) {
    T2("playsInline is set to true by default and is not currently supported as a setter.");
  }
  get preload() {
...
var de3 = class {
  ...
  get template() {
    ...
    {
      let a3 = P3.createElement("template"), e2 = this.strings.length - 1;
...
var la2 = (t3) => {
  var a3, e2, i2, r12, n3, d4, l4, b4, S2, Y4, _3, A4, R, $3, h3, ie4, W3, Z2, Ie3, Pe4, De3, Ue3, Ve2, Be2, He3, Ke3, $e3, Fe3, Ye3, We2, Ze3, Ge3, je2, ze4, Xe3, qe2, Qe3;
  return Q3`
  <media-theme
    ...
    hideduration="${(Y4 = t3.hideDuration) != null ? Y4 : false}"
  ...
  >
    <mux-video
      slot="media"
      inert="${($3 = t3.noHotKeys) != null ? $3 : false}"
      ...
      player-init-time="${(Fe3 = t3.playerInitTime) != null ? Fe3 : false}"
      ...
      env-key="${(Ze3 = t3.envKey) != null ? Ze3 : false}"
      custom-domain="${(Ge3 = t3.customDomain) != null ? Ge3 : false}"
      src="${t3.src ? t3.src : t3.playbackId ? qr(t3) : false}"
      cast-src="${t3.src ? t3.src : t3.playbackId ? qr(t3) : false}"
...
var ua2 = (t3, a3 = false) => {
  ...
  if (t3.muxCode) {
    ...
    if (t3.muxCode === D2.NETWORK_OFFLINE)
      return x("Your device appears to be offline", a3);
    if (t3.muxCode === D2.NETWORK_TOKEN_EXPIRED)
      return x("{category} URL has expired", a3).format({ category: r12 });
    if ([D2.NETWORK_TOKEN_SUB_MISMATCH, D2.NETWORK_TOKEN_AUD_MISMATCH, D2.NETWORK_TOKEN_AUD_MISSING, D2.NETWORK_TOKEN_MALFORMED].includes(t3.muxCode))
      return x("{category} URL is formatted incorrectly", a3).format({ category: r12 });
    if (t3.muxCode === D2.NETWORK_TOKEN_MISSING)
      return x("Invalid {categoryName} URL", a3).format({ categoryName: n3 });
    if (t3.muxCode === D2.NETWORK_NOT_FOUND)
...
var ca2 = (t3) => {
  if (t3.muxCode) {
    ...
    if (t3.muxCode === D2.NETWORK_TOKEN_MALFORMED)
      return "403-malformatted-token.md";
    if ([D2.NETWORK_TOKEN_AUD_MISMATCH, D2.NETWORK_TOKEN_AUD_MISSING].includes(t3.muxCode))
      return "403-incorrect-aud-value.md";
    if (t3.muxCode === D2.NETWORK_TOKEN_SUB_MISMATCH)
...
var Tt3 = `<template id="media-theme-gerwig">
  <style>
...
`;
var xe2 = P3.createElement("template");
"innerHTML" in xe2 && (xe2.innerHTML = Tt3);
var At3;
var Ct3;
...
var Ne3 = class extends Ce3 {
  constructor() {
    ...
    E(this, te3, {});
    E(this, I3, true);
    E(this, ae2, new ne3(this, "hotkeys"));
    E(this, K3, { ...Mt3, onCloseErrorDialog: (e2) => {
      var r12;
      ...
      if (((n3 = e2.composedPath()[0]) == null ? void 0 : n3.localName) !== "media-error-dialog")
        return;
      ve3(this, P3.activeElement) || e2.preventDefault();
    } });
    C5(this, J3, Gr2()), this.attachShadow({ mode: "open" }), p3(this, m3, Nt3).call(this), this.isConnected && p3(this, m3, w2).call(this);
  }
  static get NAME() {
    return Lt3;
  }
  ...
  attributeChangedCallback(e2, i2, r12) {
    switch (p3(this, m3, w2).call(this), super.attributeChangedCallback(e2, i2, r12), e2) {
      ...
      case e.PLAYBACK_ID: {
        r12 != null && r12.includes("?token") && T2(x("The specificed playback ID {playbackId} contains a token which must be provided via the playback-token attribute.").format({ playbackId: r12 }));
        break;
      }
      case e.STREAM_TYPE: {
        r12 && ![_.LIVE, _.ON_DEMAND, _.UNKNOWN].includes(r12) ? ["ll-live", "live:dvr", "ll-live:dvr"].includes(this.streamType) ? this.targetLiveWindow = r12.includes("dvr") ? Number.POSITIVE_INFINITY : 0 : Te2({ file: "invalid-stream-type.md", message: x("Invalid stream-type value supplied: `{streamType}`. Please provide stream-type as either: `on-demand` or `live`").format({ streamType: this.streamType }) }) : r12 === _.LIVE ? this.getAttribute(o2.TARGET_LIVE_WINDOW) == null && (this.targetLiveWindow = 0) : this.targetLiveWindow = Number.NaN;
        break;
      }
      case o2.FULLSCREEN_ELEMENT: {
        if (r12 != null || r12 !== i2) {
          let d4 = P3.getElementById(r12), l4 = d4 == null ? void 0 : d4.querySelector("mux-player");
          this.mediaController && d4 && l4 && (this.mediaController.fullscreenElement = d4);
        }
        break;
      }
    }
    [e.PLAYBACK_ID, M.SRC, o2.PLAYBACK_TOKEN].includes(e2) && i2 !== r12 && C5(this, K3, { ...u3(this, K3), ...Mt3 }), p3(this, m3, H3).call(this, { [st3(e2)]: r12 });
  }
  ...
  set preferCmcd(e2) {
    e2 !== this.preferCmcd && (e2 ? Zt2.includes(e2) ? this.setAttribute(e.PREFER_CMCD, e2) : x4(`Invalid value for preferCmcd. Must be one of ${Zt2.join()}`) : this.removeAttribute(e.PREFER_CMCD));
  }
  get hasPlayed() {
    var e2, i2;
  ...
  get src() {
    var e2, i2;
    return this.playbackId ? (e2 = V3(this, M.SRC)) != null ? e2 : void 0 : (i2 = this.getAttribute(M.SRC)) != null ? i2 : void 0;
  }
  set src(e2) {
  ...
  get poster() {
    ...
    if (this.playbackId && !this.audio)
      return ot2(this.playbackId, { customDomain: this.customDomain, thumbnailTime: (r12 = this.thumbnailTime) != null ? r12 : this.startTime, programTime: this.programStartTime, token: i2.thumbnail });
  }
  set poster(e2) {
  ...
  get placeholder() {
    var e2;
    return (e2 = V3(this, o2.PLACEHOLDER)) != null ? e2 : "";
  }
  set placeholder(e2) {
  ...
  get envKey() {
    var e2;
    return (e2 = V3(this, e.ENV_KEY)) != null ? e2 : void 0;
  }
  set envKey(e2) {
  ...
  get noMutedPref() {
    return this.hasAttribute(o2.NO_MUTED_PREF);
  }
  set noMutedPref(e2) {
    e2 ? this.setAttribute(o2.NO_MUTED_PREF, "") : this.removeAttribute(o2.NO_MUTED_PREF);
  }
  get debug() {
    return V3(this, e.DEBUG) != null;
  }
  set debug(e2) {
    e2 ? this.setAttribute(e.DEBUG, "") : this.removeAttribute(e.DEBUG);
  }
  get disableTracking() {
    return V3(this, e.DISABLE_TRACKING) != null;
  }
  set disableTracking(e2) {
    this.toggleAttribute(e.DISABLE_TRACKING, !!e2);
  }
  get disableCookies() {
    return V3(this, e.DISABLE_COOKIES) != null;
  }
  ...
  get startTime() {
    return y3(V3(this, e.START_TIME));
  }
  set startTime(e2) {
  ...
  set metadata(e2) {
    if (p3(this, m3, w2).call(this), !this.media) {
      T2("underlying media element missing when trying to set metadata. metadata will not be set.");
      return;
    }
  ...
  set _hlsConfig(e2) {
    if (p3(this, m3, w2).call(this), !this.media) {
      T2("underlying media element missing when trying to set _hlsConfig. _hlsConfig will not be set.");
      return;
    }
  ...
  async addCuePoints(e2) {
    var i2;
    if (p3(this, m3, w2).call(this), !this.media) {
      T2("underlying media element missing when trying to addCuePoints. cuePoints will not be added.");
      return;
    }
  ...
  addChapters(e2) {
    var i2;
    if (p3(this, m3, w2).call(this), !this.media) {
      T2("underlying media element missing when trying to addChapters. chapters will not be added.");
      return;
    }
  ...
  set castCustomData(e2) {
    if (!this.media) {
      T2("underlying media element missing when trying to set castCustomData. castCustomData will not be set.");
      return;
    }
...
J3 = /* @__PURE__ */ new WeakMap(), ee3 = /* @__PURE__ */ new WeakMap(), te3 = /* @__PURE__ */ new WeakMap(), I3 = /* @__PURE__ */ new WeakMap(), ae2 = /* @__PURE__ */ new WeakMap(), K3 = /* @__PURE__ */ new WeakMap(), m3 = /* @__PURE__ */ new WeakSet(), w2 = function() {
  var e2, i2, r12, n3;
  if (!u3(this, ee3)) {
    C5(this, ee3, true), p3(this, m3, H3).call(this);
    try {
      if (customElements.upgrade(this.mediaTheme), !(this.mediaTheme instanceof k2.HTMLElement))
        throw "";
    } catch {
      T2("<media-theme> failed to upgrade!");
    }
    try {
      customElements.upgrade(this.media);
    } catch {
      T2("underlying media element failed to upgrade!");
    }
    try {
      if (customElements.upgrade(this.mediaController), !(this.mediaController instanceof media_controller_default))
        throw "";
    } catch {
      T2("<media-controller> failed to upgrade!");
    }
    p3(this, m3, wt3).call(this), p3(this, m3, It3).call(this), p3(this, m3, Pt3).call(this), C5(this, I3, (i2 = (e2 = this.mediaController) == null ? void 0 : e2.hasAttribute(Attributes.USER_INACTIVE)) != null ? i2 : true), p3(this, m3, Dt3).call(this), (r12 = this.media) == null || r12.addEventListener("streamtypechange", () => p3(this, m3, H3).call(this)), (n3 = this.media) == null || n3.addEventListener("loadstart", () => p3(this, m3, H3).call(this));
  }
}, Nt3 = function() {
  var e2, i2;
  try {
  ...
  Object.assign(u3(this, K3), e2), p3(this, m3, H3).call(this);
}, H3 = function(e2 = {}) {
  bt3(gt3(Ea2(this, { ...u3(this, K3), ...e2 })), this.shadowRoot);
}, wt3 = function() {
  let e2 = (r12) => {
    var l4, b4;
  ...
  let e2 = (i2) => {
    ...
    n3.message && Te2(n3), T2(r12), r12.data && T2(`${r12.name} data:`, r12.data), p3(this, m3, we2).call(this, { isDialogOpen: true });
  };
  ...
  var i2, r12, n3, d4;
  let e2 = () => p3(this, m3, H3).call(this);
...
`).length, W3 = -3;
    ...
    var R, $3;
    let A4 = Array.from((($3 = (R = this.mediaController) == null ? void 0 : R.media) == null ? void 0 : $3.textTracks) || []).filter((h3) => ["subtitles", "captions"].includes(h3.kind) && h3.mode === "showing")[0];
    A4 !== i2 && (i2 == null || i2.removeEventListener("cuechange", l4)), i2 = A4, i2 == null || i2.addEventListener("cuechange", l4), d4(i2, u3(this, I3));
  };
  b4(), (S2 = this.textTracks) == null || S2.addEventListener("change", b4), (Y4 = this.textTracks) == null || Y4.addEventListener("addtrack", b4), this.addEventListener("userinactivechange", () => {
    var A4, R;
...
var B4 = (e2) => e2 == null;
var ee4 = (e2, t3) => B4(t3) ? false : e2 in t3;
...
var xe3 = (e2, t3) => {
  let { onAbort: n3, onCanPlay: o4, onCanPlayThrough: a3, onEmptied: l4, onLoadStart: i2, onLoadedData: c4, onLoadedMetadata: v4, onProgress: R, onDurationChange: T3, onVolumeChange: h3, onRateChange: b4, onResize: C6, onWaiting: k3, onPlay: O4, onPlaying: S2, onTimeUpdate: w3, onPause: N4, onSeeking: L4, onSeeked: A4, onStalled: I4, onSuspend: _3, onEnded: K4, onError: H4, onCuePointChange: D5, onChapterChange: V4, metadata: W3, tokens: U4, paused: z3, playbackId: F4, playbackRates: G3, currentTime: Z2, themeProps: j4, extraSourceParams: q4, castCustomData: J4, _hlsConfig: Y4, ...$3 } = t3;
  return u4("tokens", U4, e2), u4("playbackId", F4, e2), u4("playbackRates", G3, e2), u4("metadata", W3, e2), u4("extraSourceParams", q4, e2), u4("_hlsConfig", Y4, e2), u4("themeProps", j4, e2), u4("castCustomData", J4, e2), u4("paused", z3, e2, (s3, y5) => {
  ...
  }), r11("abort", e2, n3), r11("canplay", e2, o4), r11("canplaythrough", e2, a3), r11("emptied", e2, l4), r11("loadstart", e2, i2), r11("loadeddata", e2, c4), r11("loadedmetadata", e2, v4), r11("progress", e2, R), r11("durationchange", e2, T3), r11("volumechange", e2, h3), r11("ratechange", e2, b4), r11("resize", e2, C6), r11("waiting", e2, k3), r11("play", e2, O4), r11("playing", e2, S2), r11("timeupdate", e2, w3), r11("pause", e2, N4), r11("seeking", e2, L4), r11("seeked", e2, A4), r11("stalled", e2, I4), r11("suspend", e2, _3), r11("ended", e2, K4), r11("error", e2, H4), r11("cuepointchange", e2, D5), r11("chapterchange", e2, V4), [$3];
};
var de4 = g7();
var fe3 = "mux-player-react";
var ge4 = import_react.default.forwardRef((e2, t3) => {
  var i2;
  let n3 = (0, import_react.useRef)(null), o4 = f5(n3, t3), [a3] = xe3(n3, e2), [l4] = (0, import_react.useState)((i2 = e2.playerInitTime) != null ? i2 : Gr2());
  return import_react.default.createElement(Pe3, { ref: o4, defaultHiddenCaptions: e2.defaultHiddenCaptions, playerSoftwareName: fe3, playerSoftwareVersion: de4, playerInitTime: l4, ...a3 });
});
var ze3 = ge4;
export {
  rr2 as MaxResolution,
  f as MediaError,
  nr2 as MinResolution,
  or2 as RenditionOrder,
  ze3 as default,
  Gr2 as generatePlayerInitTime,
  fe3 as playerSoftwareName,
...
mux-embed/dist/mux.mjs:
  ...
  *)
*/
//# sourceMappingURL=dist-7BDSOMNW.js.map

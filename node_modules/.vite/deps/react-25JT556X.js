...
var _loadRequested, _hasLoaded, _readyState, _seeking, _seekComplete, _error, _config, _upgradeProperty, upgradeProperty_fn;
var YoutubeVideoElement = class extends (globalThis.HTMLElement ?? class {
  ...
  constructor() {
    ...
    __privateAdd(this, _seekComplete, void 0);
    ...
    this.loadComplete.then(() => {
      ...
      if (this.paused) {
        (_b = __privateGet(this, _seekComplete)) == null ? void 0 : _b.then(() => {
          var _a2;
          if (!__privateGet(this, _seekComplete))
            return;
...
youtube-video-element/dist/react.js:
  ...
  *)
*/
//# sourceMappingURL=react-25JT556X.js.map

...
var EMBED_BASE = "https://player.twitch.tv";
var MATCH_VIDEO = /(?:www\.|go\.)?twitch\.tv\/(?:videos?\/|\?video=)(\d+)($|\?)/;
var MATCH_CHANNEL = /(?:www\.|go\.)?twitch\.tv\/([a-zA-Z0-9_]+)($|\?)/;
var PlaybackState = {
  IDLE: "Idle",
  READY: "Ready",
  BUFFERING: "Buffering",
...
var TwitchVideoElement = class extends (globalThis.HTMLElement ?? class {
}) {
  constructor() {
    super();
  ...
  getVideoPlaybackQuality() {
    return __privateGet(this, _playerState).stats.videoStats;
  }
  get src() {
...
twitch-video-element/dist/react.js:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=react-JGZLVCXI.js.map
